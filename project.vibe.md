...
meta:
  ...
  description: >
    ...
    context, and quality criteria for the VIBE v1 planning document format.
  author: human
  tags:
    - root
    - project
...
- All .vibe.md files must declare vibe: "1.0" in frontmatter
...
|------|------|-------------|--------|
| vibe/spec/VIBE_SPEC_v1.md | markdown | Core language specification | complete |
...
The VIBE v1 document lifecycle:

1. Write: AI or human creates a .vibe.md document
2. Validate: Document is checked against the v1 schema
3. Review: Humans or AI review sections, decisions, quality
4. Import: Other documents can import and build on this one

VIBE uses a document-oriented model. Documents are the deliverable.

## Quality

| ID | Type | Description | Criteria |
|----|------|-------------|----------|
| q_project_valid | test | All .vibe.md files in the project are valid v1 format | Every .vibe.md file in the repository has vibe: "1.0" and validates against vibe/schema/vibe.schema.json |
